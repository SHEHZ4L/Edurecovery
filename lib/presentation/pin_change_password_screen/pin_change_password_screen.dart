import 'models/pin_change_password_model.dart';import 'package:edurecovery/core/app_export.dart';import 'package:edurecovery/widgets/app_bar/appbar_leading_image.dart';import 'package:edurecovery/widgets/app_bar/appbar_subtitle_two.dart';import 'package:edurecovery/widgets/app_bar/custom_app_bar.dart';import 'package:edurecovery/widgets/custom_elevated_button.dart';import 'package:edurecovery/widgets/custom_pin_code_text_field.dart';import 'package:flutter/material.dart';import 'provider/pin_change_password_provider.dart';class PinChangePasswordScreen extends StatefulWidget {const PinChangePasswordScreen({Key? key}) : super(key: key);

@override PinChangePasswordScreenState createState() =>  PinChangePasswordScreenState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => PinChangePasswordProvider(), child: PinChangePasswordScreen()); } 
 }
class PinChangePasswordScreenState extends State<PinChangePasswordScreen> {@override void initState() { super.initState(); } 

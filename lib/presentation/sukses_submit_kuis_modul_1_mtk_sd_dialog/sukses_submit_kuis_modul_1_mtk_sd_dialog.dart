import 'models/sukses_submit_kuis_modul_1_mtk_sd_model.dart';import 'package:edurecovery/core/app_export.dart';import 'package:edurecovery/widgets/custom_elevated_button.dart';import 'package:flutter/material.dart';import 'provider/sukses_submit_kuis_modul_1_mtk_sd_provider.dart';class SuksesSubmitKuisModul1MtkSdDialog extends StatefulWidget {const SuksesSubmitKuisModul1MtkSdDialog({Key? key}) : super(key: key);

@override SuksesSubmitKuisModul1MtkSdDialogState createState() =>  SuksesSubmitKuisModul1MtkSdDialogState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => SuksesSubmitKuisModul1MtkSdProvider(), child: SuksesSubmitKuisModul1MtkSdDialog()); } 
 }
class SuksesSubmitKuisModul1MtkSdDialogState extends State<SuksesSubmitKuisModul1MtkSdDialog> {@override void initState() { super.initState(); } 
...
/// Navigates to the hasilSkorKuisModul1MtkSdScreen when the action is triggered.
onTapLihatSkor(BuildContext context) { NavigatorService.pushNamed(AppRoutes.hasilSkorKuisModul1MtkSdScreen, ); } 
 }
